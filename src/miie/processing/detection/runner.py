...
class DetectorRunner:
    ...
    def run_all(self, metric_dataframe: MetricDataFrame) -> List[DetectorResult]:
        """
        ...
        detectors = sorted(self._registry.get_all(), key=lambda d: d.get_detector_id())
    ...
    def run_specific(self, metric_dataframe: MetricDataFrame, detector_ids: List[str]) -> List[DetectorResult]:
        """
