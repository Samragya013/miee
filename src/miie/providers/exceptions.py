"""
MIIE v1.6 Observation Provider Framework — Error hierarchy.
...
from miie.providers.context import ProviderErrorContext
...
class PartialExtractionError(ExtractionError):
    ...
    def __init__(self, message: str, partial_results: Optional[List[Any]] = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
...
class ValidationError(ObservationError):
    ...
    def __init__(self, message: str, violations: Optional[List[str]] = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
...
def create_provider_error(
    ...
    **kwargs: Any,
    ...
    return error_class(message=message, context=context, cause=cause, **kwargs)
