"""
Health reporting for the Repository Metadata provider.

Tracks API availability, response latency, rate-limit status,
and metadata completeness to produce structured health snapshots.
"""
...
@dataclass
class RepositoryProviderHealth:
    """Mutable health tracker for the Repository Metadata provider."""
    ...
    _metadata_completeness: float = 0.0

    def record_success(self, latency_ms: float = 0.0, metadata_completeness: float = 1.0) -> None:
        ...
        self._metadata_completeness = metadata_completeness
        self._recalculate()
